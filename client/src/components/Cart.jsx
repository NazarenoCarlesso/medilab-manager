   ...
   return (
      ...
      >
         {cart.length === 0 ? (
            ...
            >
               <Typography variant="h3" fontWeight={700} sx={{ fontFamily: "Raleway", margin: 4, textAlign: "center" }}>
                  Tu carrito de compra está vacío
               </Typography>
               <Typography variant="h5" fontWeight={700} sx={{ fontFamily: "Raleway", margin: 4, textAlign: "center" }}>
            ...
            <div style={{ width: "85%", position: "relative" }}>
               ...
               >
                  ...
                  >
                     ...
                     >
                        <Button variant="contained" size="large" as={Link} to="/search" style={{ textDecoration: "none", marginRight: "5px" }}>
                           SIGUE COMPRANDO
                        </Button>
                        {token ? (
         ...
         {/* Canva de seleccionar método de pago */}
         <div>
