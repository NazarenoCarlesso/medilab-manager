  ...
  return (
    <div style={{ display: "inline-block", marginTop: "10px" }}>
      <div style={location.pathname === "/signup" ? { display: "flex", justifyContent: "center", width: "1200px", margin: "auto", marginTop: "0px" } : { display: "inline-block" }}>
        ...
        {/* Formulario */}
        <div style={location.pathname === "/signup" ? { textAlign: "center", margin: "auto", display: "flex", flexDirection: "column", alignItems: "center", width: "600px" } : { textAlign: "center", margin: "auto", display: "flex", flexDirection: "column", alignItems: "center" }}>
