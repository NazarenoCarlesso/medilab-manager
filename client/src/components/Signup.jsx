  ...
  return (
    <div style={{ textAlign: "center", margin: "auto", padding: "10px" }}>
      {location.pathname === "/signup" ? (
        <div style={{ margin: "2%" }}>
          <ToggleButtonGroup type="radio" name="options" defaultValue={1} value={selectedForm === "login" ? 1 : 2}>
            <ToggleButton value={1} id="tbg-radio-2" name="login" onClick={(e) => handleSelect(e)} variant="outline-primary">
              Iniciar Sesión
            </ToggleButton>
            <ToggleButton value={2} id="tbg-radio-1" name="signup" onClick={(e) => handleSelect(e)} variant="outline-primary">
              Registrarse
            </ToggleButton>
          </ToggleButtonGroup>
        </div>
      ...
      >
        ...
        {location.pathname === "/cart" ? (
          selectedForm === "signup" ? (
            <div style={{ position: "absolute", top: "10px", left: "10px" }}>
              <Button variant="contained" onClick={() => setSelectedForm("login")}>
                {"< Iniciar Sesión"}
              </Button>
            </div>
          ) : null
        ...
        <Row style={{ width: "300px", margin: "auto" }}>
          {selectedForm === "signup" ? <p>Regístrese con Google</p> : <p>Inicie Sesión con Google</p>}
          <div
            style={{
              display: "flex",
        ...
        {/* Línea */}
        <Row style={selectedForm === "login" ? { width: "300px", margin: "auto" } : { width: "650px", margin: "auto" }}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.firstName ? errorsUserSignUp.firstName : null}</p>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.lastName ? errorsUserSignUp.lastName : null}</p>
                  </Form.Group>
                </Col>
              </Row>
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.username ? errorsUserSignUp.username : null}</p>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group className="mb-3">
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.number ? errorsUserSignUp.number : null}</p>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group className="mb-3">
              ...
              <Row>
                ...
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.height ? errorsUserSignUp.height : null}</p>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.civilState ? errorsUserSignUp.civilState : null}</p>
                  </Form.Group>
                </Col>
              </Row>
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.password ? errorsUserSignUp.password : null}</p>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    />
                    <p style={{ color: "red", fontSize: "12px" }}>{userSignUp.touched.confirmPassword ? errorsUserSignUp.confirmPassword : null}</p>
                  </Form.Group>
                </Col>
              </Row>
              <Button
