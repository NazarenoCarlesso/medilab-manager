    ...
    return (
        <Card className="shadow-sm p-3 mb-5 bg-white" style={{ width: 250, height: 320, marginLeft: 10, marginRight: 10}}>
            ...
            <Card.Body>
                ...
                <Button variant="outline-primary" as={Link} to={`/detail/${id}`}>Detail</Button>
                <Button variant="outline-success" onClick={() => dispatch(addToCart(id))} style={{ marginLeft: 10 }}>Add to Cart</Button>
            </Card.Body>
        </Card>
    )
}
